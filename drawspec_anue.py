...
h_ws = ROOT.TH1F("h_ws","Wrong Sign", 30, 0.5, 8.0)
...
datfile = open("data/spec_anu_no_5years.dat")
...
nsig = h.Integral(h.FindBin(0.501),h.FindBin(7.99))
nws = h_ws.Integral(h_ws.FindBin(0.501),h_ws.FindBin(7.99))
nNC = h_NC.Integral(h_NC.FindBin(0.501),h_NC.FindBin(7.99))
nnumu = h_numu.Integral(h_numu.FindBin(0.501),h_numu.FindBin(7.99))
nnutau = h_nutau.Integral(h_nutau.FindBin(0.501),h_nutau.FindBin(7.99))
hbeamnue = h_beamnue.Integral(h_beamnue.FindBin(0.501),h_beamnue.FindBin(7.99))

print "Signal: ", nsig
print "Signal (right-sign): ", nsig-nws
print "Signal (wrong-sign): ", nws
print "NC: ", nNC
print "numu: ", nnumu
print "nutau: ", nnutau
